...
unsigned bwd_reach1_b(unsigned *nodes, unsigned *nodesT, unsigned countOfNodes, unsigned *edges, unsigned *edgesT, unsigned countOfEdges, unsigned char *states, alg_opt opt, int *h_degree, int source);
